...
class MainActivity : AppCompatActivity() {
    ...
    private val ListGambar = intArrayOf(R.drawable.soekarno, R.drawable.soeharto, R.drawable.habibie, R.drawable.gusdur, R.drawable.mega, R.drawable.sby, R.drawable.jkw)
    private val ListNama = arrayOf("Dr. Ir. H. Soekarno",
        ...
        "Ir. H. Joko Widodo")
    private val ListKeterangan = arrayOf("Soekarno, nama lahir: Koesno Sosrodihardjo (lahir di Surabaya, Jawa Timur, 6 Juni 1901 – meninggal di Jakarta, 21 Juni 1970 pada umur 69 tahun) adalah Presiden pertama Republik Indonesia yang menjabat pada periode 1945–1967.",
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listview.setOnItemClickListener { parent, view, position, id ->
            Toast.makeText(this,"you chose : ${ListKeterangan[position]}", Toast.LENGTH_SHORT).show()}
    }
